...
const Sidebar: React.FC<SidebarProps> = ({
  ...
  return (
    <div
      className={`bg-muted/50 text-foreground flex flex-col transition-width duration-300 ${isCollapsed ? 'w-20' : 'w-80'}`}
    >
      ...
      <div className="flex-grow p-2 space-y-2 overflow-y-auto">
        <button
          onClick={onNewChat}
          className="w-full flex items-center justify-center bg-primary hover:bg-primary/90 text-primary-foreground font-bold py-2 px-4 rounded"
        >
          <NewChatIcon />
